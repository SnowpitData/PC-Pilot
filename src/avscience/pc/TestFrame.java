...
///	private MenuItem editMenuItem = new java.awt.MenuItem();
    ...
    //	String[] fcss = {" ", "SP", "SC", "PC", "RP"};
    	...
    	System.out.println("Test: "+testType.getSelectedItem().trim());
    	///////////
    ...
    //    editMenuItem.setLabel("Edit test");
	...
	void addTest()
	{
        ...
        if ( tScore.equals("SBN") || tScore.equals("CTN") || tScore.equals("RB7") || tScore.equals("STN") || tScore.equals("ECTX")) noFail=true;
        if ( (( depth.getText().trim().length() > 0)&&(dpth>=0)) || noFail)
        {
        	if ( validateForm())
        	{
	            ...
	            {
	                tests.add(name);
	              	pframe.getPit().addShearTestResult(result.dataString());
	...
	public boolean validateForm()
	{
		...
		if ( tScore.equals("CTE") && ctscore.getText().trim().equals("0"))
        {
         ...
         if ( tScore.equals("CTH"))
         {
         	...
         	{
         		valid=false;
         		displayMsg("CTM score must be 21-30");
         		return false;
           	}
         }
		return true;
	...
	avscience.ppc.ShearTestResult getTestResultFromForm()
	{
        ...
        avscience.ppc.ShearTestResult result = new avscience.ppc.ShearTestResult(code, score, quality, dpth, dunits, comments, cscore, escore, character, fcat);
	...
	class MenuAction implements java.awt.event.ActionListener
	{
		...
		{
			Object object = event.getSource();
            if ((object == addMenuItem )||(object==add)) 
            {
            	addTest();
            }
       ...
       ///     if ( object == editMenuItem ) editTest();
